...
# [aws/](aws/)# AWS Examples


# [aws/aws_domain_redirect](aws/aws_domain_redirect)# aws_domain_redirect
...
# [aws/aws_ec2_ebs_docker_host](aws/aws_ec2_ebs_docker_host)# aws_ec2_ebs_docker_host
...
# [aws/aws_lambda_api](aws/aws_lambda_api)# aws_lambda_api
...
# [aws/aws_lambda_cronjob](aws/aws_lambda_cronjob)# aws_lambda_cronjob
...
# [aws/aws_mailgun_domain](aws/aws_mailgun_domain)# aws_mailgun_domain
...
# [aws/aws_reverse_proxy](aws/aws_reverse_proxy)# aws_reverse_proxy
...
# [aws/aws_static_site](aws/aws_static_site)# aws_static_site
...
# [aws/websites/static_website_ssl_cloudfront_private_s3](aws/websites/static_website_ssl_cloudfront_private_s3)# Static website hosted using S3 and cloudfront with SSL support
...
# [azure/layers](azure/layers)# Terraform Azure Layers example
...
# [generic/docker_compose_host](generic/docker_compose_host)# docker_compose_host
...
# [google_cloud/](google_cloud/)# Google Cloud Platform Examples


# [google_cloud/camunda](google_cloud/camunda)## Provisioning Camunda on Cloud Run + Cloud SQL, using Terraform and Cloud Build
...
# [google_cloud/CQRS_bigquery_memorystore](google_cloud/CQRS_bigquery_memorystore)## CQRS Bigquery Memorystore Timeseries Analytics with Self Testing Example
